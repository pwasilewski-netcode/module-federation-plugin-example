import { Compiler, Injector, ModuleWithProviders, NgModuleFactory, NgModuleRef, StaticProvider, Type } from "@angular/core";

export class PluginModuleFactory<T> extends NgModuleFactory<T> {
